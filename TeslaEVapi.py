...
class teslaEVAccess(object):
    ...
    def teslaEV_streaming_synched(self, EVid):
        try:
            ...
            code, res  = self.tesla_api._callApi('GET','/vehicles/'+str(EVid) +'/fleet_telemetry_config')
    ...
    def teslaEV_streaming_delete_config(self, EVid):
        try:
            ...
            code, res  = self.tesla_api._callApi('DELETE','/vehicles/'+str(EVid) +'/fleet_telemetry_config')
            if code == 'ok':
                return(code, res)                         
        except Exception:
            return (None, None)
    ...
    def teslaEV_streaming_create_config(self, vin_list, Cert_CA):
        ...
        code, res  = self.tesla_api._callApi('POST','/vehicles/fleet_telemetry_config', payload)
