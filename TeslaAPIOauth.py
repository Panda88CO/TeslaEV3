...
class teslaApiAccess(teslaAccess):
    ...
    def teslaEV_streaming_create_config(self, vin_list, Cert_CA):
        ...
        stream_fields = {                  
                        ...
                        'ChargeAmps' : { 'interval_seconds': 20, 'minimum_delta': 0.5, },
                        'TimeToFullCharge' : { 'interval_seconds': 60, 'minimum_delta': 1,  },
                        'Soc' : { 'interval_seconds': 60, 'minimum_delta': 1 },
                        'ChargerVoltage' : { 'interval_seconds': 20, 'minimum_delta': 2, },                    
                        ...
                        'DCChargingEnergyIn': { 'interval_seconds': 20, 'minimum_delta': 5 },
                        'DCChargingPower' : { 'interval_seconds': 20, 'minimum_delta': 5 },
                        'ACChargingEnergyIn': { 'interval_seconds': 20,'minimum_delta': 5 },
                        'ACChargingPower' : { 'interval_seconds': 20 ,'minimum_delta': 5},
